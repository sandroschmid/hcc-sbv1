...
public class CSV implements AutoCloseable {
	...
	/**
	 * Default configuration for the CSV file.
	 * Either adopt this to your needs here for a global defaults or use
	 * {@link #setDefaultConfig(Config)} before creating {@link CSV}-instances.
	 */	
	...
	/**
	 * Sets a default configuration for any future CSV-files.
	 * Note that previously create {@link CSV}-instances will not be affected by this change.
	 * 
	 * @param defaultConfig
	 */
	 ...
	 * Use {@link #open()} to create and open the actual file before adding any lines.
	 * Not opening the file first will result in an {@link IllegalStateException}.
	 * 
	 * @param filename
	 * @throws IOException
	 */
	...
	/**
	 * Adds a row of cells with {@code byte}-values.
	...
	/**
	 * Adds a row of cells with {@code byte}-values {@code n} times.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@code byte}-values to use for the new CSV-row
	...
	/**
	 * Adds a row of cells with {@code int}-values.
	 * Once added, a row cannot be changed anymore.
	 * 
	...
	/**
	 * Adds a row of cells with {@code int}-values {@code n} times.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@code int}-values to use for the new CSV-row
	 * @param n Number of copies of the {@code row}
	...
	/**
	 * Adds a row of cells with {@code long}-values.
	 * Once added, a row cannot be changed anymore.
	 * 
	...
	/**
	 * Adds a row of cells with {@code long}-values {@code n} times.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@code long}-values to use for the new CSV-row
	 * @param n Number of copies of the {@code row}
	...
	/**
	 * Adds a row of cells with translated {@code double}-values.
	 * Once added, a row cannot be changed anymore.
	 * 
	...
	/**
	 * Adds a row of cells with translated {@code double}-values {@code n} times.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@code double}-values to use for the new CSV-row
	 * @param n Number of copies of the {@code row}
	...
	/**
	 * Adds a row of cells with translated {@code float}-values.
	 * Once added, a row cannot be changed anymore.
	 * 
	...
	/**
	 * Adds a row of cells with translated {@code float}-values {@code n} times.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@code float}-values to use for the new CSV-row
	 * @param n Number of copies of the {@code row}
	...
	/**
	 * Adds a row of cells with {@link String}-values.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@link String}-values to use for the new CSV-row
	 * @return {@link CSV}-builder
	...
	/**
	 * Adds a row of cells with {@link String}-values {@code n} times.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row Cells with {@link String}-values to use for the new CSV-row
	 * @param n Number of copies of the {@code row}
	...
	/**
	 * Gets the current cells of the {@link Row} and adds them to the file.
	 * Once added, a row cannot be changed anymore.
	 * 
	...
	/**
	 * Gets the current cells of the {@link Row} and adds them {@code n} times to the file.
	 * Once added, a row cannot be changed anymore.
	 * 
	 * @param row {@link Row}-builder to use for the new CSV-row
	 * @param n Number of copies of the {@code row}
	...
	/**
	 * Saves and closes the CSV-file. Note that the file has to be opened again before
	 * any further rows can be added.
	 * 
	 * @throws IOException
	 */
	@Override
	...
	private void appendRow(final String row, final int n) throws IOException {
		...
		for (int i = 0; i < n; i++) {
			writer.append(row).append(config.linebreak);
		}
	}
	...
	public class Row {
		...
		/**
		 * Private constructor. 
		 * Use {@code row()} on a {@link CSV}-instance for creating new {@link Row}-instances.
		 */
		private Row() {
			// nothing to do
		}
		...
		/**
		 * Adds a cell with a {@code byte}-value.
		...
		/**
		 * Adds a cell {@code n} times with a {@code byte}-value.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		...
		/**
		 * Adds a cell with a {@code int}-value.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		 * @return {@link Row}-builder
		...
		/**
		 * Adds a cell {@code n} times with a {@code int}-value.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		 * @param n How often the {@code value} should be added
		...
		/**
		 * Adds a cell with a {@code long}-value.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		 * @return {@link Row}-builder
		...
		/**
		 * Adds a cell {@code n} times with a {@code long}-value.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		 * @param n How often the {@code value} should be added
		...
		/**
		 * Adds a cell {@code n} times with a {@code float}-value.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		 * @param n How often the {@code value} should be added
		...
		/**
		 * Adds a cell with a {@link String}-value.
		 * If {@code value} is {@code null}, an empty cell will be added.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		 * @return {@link Row}-builder
		...
		/**
		 * Adds a cell {@code n} times with a {@link String}-value.
		 * If {@code value} is {@code null}, an empty cell will be added.
		 * Once added, a cell cannot be changed anymore.
		 * 
		 * @param value The cell's value
		...
		public Row cell(final String value, final int n) {
			if (value != null) {
				for (int i = 0; i < n; i++) {
					row.append(value).append(CSV.CELL_DELIMITER);
				}
			} else {
...
//		 * Adds a cell for each {@link String}-value in the array.
		...
		public String build() {
			...
			if (lastCharIndex >= 0) {
				if (String.valueOf(row.charAt(lastCharIndex)).equals(CSV.CELL_DELIMITER)) {
